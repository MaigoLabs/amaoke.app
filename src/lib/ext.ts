...
// Make enumerable false to avoid for..in loops from iterating over these methods
for (const key of [
    "let",
    "also",
    "run",
    ...
    Object.defineProperty(Number.prototype, key, { enumerable: false });
    Object.defineProperty(String.prototype, key, { enumerable: false });
    Object.defineProperty(Boolean.prototype, key, { enumerable: false });
}